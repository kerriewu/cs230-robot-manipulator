...
# box_3dof.py
#
# Environment for 3-dof robotic arm with box action space.
...
class Box3DoF(gym.Env):
    ...
    def __init__(self, reward_loc=[5., 8.], 
        ...
        """
        Creates a new environment for a 3-dof arm with box action space.
    ...
    def step(self, action):
        ...
        Args:
            action (shape 3,) Arm angle update deltas
